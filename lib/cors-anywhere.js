...
function parseURL(req_url) {
  ...
  // Because of how passenger works (https://groups.google.com/d/topic/phusion-passenger/92kDtW7_2YQ)
  // We'll get https:/ instead of https://, so we need to make adjustment.
  req_url =
    (match[3] === "443" || req_url.startsWith("https") ? "https" : "http") +
    "://" +
    req_url.substr((match[1] || "").length);
